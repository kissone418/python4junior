...
[6]執行別人github上的XX.ipynb檔

[7]上傳程式到GOOGLE drive, 從Google drive 開啟xxx.ipynb

[8]上傳檔案到colab
[9]執行colab上的xxx.py程式

[10]把整個別人分享的github  git clone到你的colab
[11]載入你的google drive 到colab
```
